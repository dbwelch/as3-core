package org.flashx.io.loaders.types {
	...
	*	@since  29.10.2010
	*/
	public class VariableResourceNotFoundTest extends AbstractLoaderUnit {
		
		/**
		*	Creates a <code>VariableResourceNotFoundTest</code> instance.
		*/
		public function VariableResourceNotFoundTest()
		{
			super();
		}
		...
		*/
		...
		{
			return new URLRequest( "assets/test-resource-not-found.variables" );
		}
		...
		*/
		...
		{
			Assert.assertEquals( "assets/test-resource-not-found.variables", event.uri );
			Assert.assertEquals( LoadEvent.RESOURCE_NOT_FOUND, event.type );
			Assert.assertTrue( event.loader is VariableLoader );
