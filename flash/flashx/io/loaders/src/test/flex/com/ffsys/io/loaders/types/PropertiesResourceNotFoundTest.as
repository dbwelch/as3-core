package com.ffsys.io.loaders.types {
	...
	*	@since  29.10.2010
	*/
	public class PropertiesResourceNotFoundTest extends AbstractLoaderUnit {
		
		/**
		*	Creates a <code>PropertiesResourceNotFoundTest</code> instance.
		*/
		public function PropertiesResourceNotFoundTest()
		{
			super();
		}
		...
		*/
		...
		{
			return new URLRequest( "assets/test-resource-not-found.properties" );
		}
		...
		*/
		...
		{
			Assert.assertEquals( "assets/test-resource-not-found.properties", event.uri );
			Assert.assertEquals( LoadEvent.RESOURCE_NOT_FOUND, event.type );
			Assert.assertTrue( event.loader is PropertiesLoader );
