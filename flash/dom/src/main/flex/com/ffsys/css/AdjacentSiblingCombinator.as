...
{
	/**
	* 	A combinator selector for adjacent sibling elements.
	*
	...
	*	@since  24.01.2011
	*/
	public class AdjacentSiblingCombinator extends CombinatorSelector
	{		
		/**
		* 	Creates a <code>AdjacentSiblingCombinator</code> instance.
		* 
		...
		*/
		public function AdjacentSiblingCombinator(
			operand:String = null,
