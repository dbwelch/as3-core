package com.ffsys.dom.xhtml
{
	...
	/**
	*	Represents a caption, the <code>caption</code> element.
	* 
	...
	*	@since  24.01.2011
	*/
	dynamic public class CaptionElement extends VisualElement
	{
		/**
		* 	Creates a <code>CaptionElement</code> instance.
		* 
		* 	@param xml An <code>XML</code> fragment that
		* 	defines the element.
		*/
		public function CaptionElement( xml:XML = null )
		{
			super( xml );
		}
	}
