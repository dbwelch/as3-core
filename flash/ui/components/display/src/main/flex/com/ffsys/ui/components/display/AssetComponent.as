package com.ffsys.ui.components.display
{
	...
	*	@since  16.06.2010
	*/
	public class AssetComponent extends InteractiveComponent
	{
		private var _classPath:String;
		private var _asset:DisplayObject;
		
		/**
		* 	Creates an <code>AssetComponent</code> instance.
		* 
		* 	@param classPath The fully qualified class path to the
		* 	display object asset.
		*/
		public function AssetComponent( classPath:String )
		{
			super();
