package com.ffsys.w3c.xni.parser
{
	...
	* 	interface is able to emit DTD content model "events"
	* 	to the registered DTD content model handler.
	* 
	* 	These events could be produced by parsing an XML
	* 	document's internal or external subset, could be generated 
	* 	from some other source, or could be created programmatically.
