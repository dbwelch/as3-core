	...
	*/ 
	public class LoaderSupportTest extends AbstractBeanUnit
	{
		...
		public var sample:String = 
			...
			loader-factory {
				instance-class: class( org.flashx.ioc.support.LoaderFactory );
				singleton: true;
				extensions: ref( loader-file-extensions );
			}
			
			loader-file-extensions {
				instance-class: class( org.flashx.ioc.support.FileTypeClassMapping );
				singleton: true;
			}
			
			named-list {
				instance-class: class( org.flashx.ioc.support.ListLoaderBuilder );
			...
			simple-sequence {
				instance-class: class( org.flashx.ioc.support.SequenceLoaderBuilder );
				loader-factory: ref( loader-factory );
