package org.w3c.dom.events
{
	...
	* 	by which the user can create an Event of a type
	* 	supported by the implementation. It is expected
	* 	that the DocumentEvent interface will be implemented
	* 	on the same object which implements the Document
	* 	interface in an implementation which supports
	* 	the Event model.
	*/
	public interface DocumentEvent
	{
		...
		* 
		* 	@param eventType The eventType parameter specifies
		* 	the type of Event interface to be created.
		* 	If the Event interface specified is supported
		* 	by the implementation this method will return
		* 	a new Event of the interface type requested.
