package org.w3c.dom.css
{
	...
	* 	within a CSS declaration block, it is expected to provide
	* 	access to all specified properties in the style sheet through
	* 	the CSSStyleDeclaration interface. Furthermore, implementations
	* 	that support a specific level of CSS should correctly handle
	...
	* 	to the computed values of an element. See also the ViewCSS interface.
	* 
	* 	Note: The CSS Object Model doesn't provide an access to
	* 	the specified or actual values of the CSS cascade.
	* 
	...
	*/
	...
	{
		/**
		* 	The parsable textual representation of the declaration
		* 	block (excluding the surrounding curly braces).
		* 
		* 	Setting this attribute will result in the parsing of the new
		* 	value and resetting of all the properties in the declaration
		...
		* 	this declaration is readonly or a property is readonly.
		*/
		...
		* 	in this declaration block. The range of valid indices is
		...
		* 	null if this CSSStyleDeclaration is not attached to a CSSRule.
		*/
		function get parentRule():CSSRule;
		
		/**
		* 	Used to retrieve the properties that have been explicitly
		* 	set in this declaration block. The order of the properties
		* 	retrieved using this method does not have to be the order
		* 	in which they were set. This method can be used to iterate
		* 	over all properties in this declaration block.
		* 
		* 	@param index Index of the property name to retrieve.
		* 
		* 	@return The name of the property at this ordinal position.
		* 	The empty string if no property exists at this position.
		*/
		function item( index:uint ):String;
		
		/**
		* 	Used to retrieve the object representation of the value
		* 	of a CSS property if it has been explicitly set within
		* 	this declaration block.
		* 
		* 	This method returns null if the property is a shorthand property.
		* 	Shorthand property values can only be accessed and modified as
		* 	strings, using the getPropertyValue and setProperty methods.
		* 	
		* 	@param propertyName The name of the CSS property.
		* 	See the CSS property index.
		* 	
		* 	@return Returns the value of the property if it
		* 	has been explicitly set for this declaration block.
		...
		* 	See the CSS property index.
		* 
		* 	@return A string representing the priority
		* 	(e.g. "important") if one exists. The empty string
		* 	if none exists.
		*/
		...
		/**
		* 	Used to retrieve the value of a CSS property if it
		* 	has been explicitly set within this declaration block.
		* 
		* 	@param propertyName The name of the CSS property.
		* 	See the CSS property index.
		* 
		* 	@return Returns the value of the property if it has
		* 	been explicitly set for this declaration block. Returns
		...
		* 	@return Returns the value of the property if it
		* 	has been explicitly set for this declaration block.
		* 	Returns the empty string if the property has not been
		* 	set or the property name does not correspond to a
		* 	known CSS property.
		*/
		...
		/**
		* 	Used to set a property value and priority within
		* 	this declaration block.
		* 	
		* 	@param propertyName The name of the CSS property.
		* 	See the CSS property index.
		* 	@param value The new value of the property.
		* 	@param priority The new priority of the property
		* 	(e.g. "important").
		* 
		* 	@throws DOMException.SYNTAX_ERR: Raised if the specified value
