package org.xml.sax
{
	...
	* 	as if it came from a Locator object. Note that 
	* 	although the application will receive a SAXParseException
	* 	as the argument to the handlers in the ErrorHandler
	* 	interface, the application is not actually required
	* 	to throw the exception; instead, it can simply read
	* 	the information in it and take a different action.
	*/
	public class SAXException extends Exception
	{
		/**
		* 	Creates a <code>SAXException</code> instance.
		* 
