package com.ffsys.io.loaders.types {
	...
	*	@since  29.10.2010
	*/
	public class MovieResourceNotFoundTest extends AbstractLoaderUnit {
		
		/**
		*	Creates a <code>MovieResourceNotFoundTest</code> instance.
		*/
		public function MovieResourceNotFoundTest()
		{
			super();
		}
		...
		*/
			...
			passThroughData:Object ):void
		{
			...
			Assert.assertTrue( event.loader is MovieLoader );
