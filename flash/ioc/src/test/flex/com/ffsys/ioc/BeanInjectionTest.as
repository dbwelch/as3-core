	...
	*/ 
	...
	{	
		...
		public var sample:String = 
			...
			injector {
				instance-class: class( com.ffsys.ioc.BeanInjector );
				singleton: true;
			}
			
			application {
				instance-class: class( com.ffsys.ioc.mock.MockApplicationBean );
				singleton: true;
			}
			
			messages {
				instance-class: class( com.ffsys.ioc.mock.MockMessagesBean );
				singleton: true;
			}
			
			configuration {
				instance-class: class( com.ffsys.ioc.mock.MockConfigurationBean );
				singleton: true;
			}
			
			applicationController {
				instance-class: class( com.ffsys.ioc.mock.MockApplicationControllerBean );
				singleton: true;
				controller: ref( home-controller );
			}
			
			locales {
				instance-class: class( com.ffsys.ioc.mock.MockLocaleManager );
				singleton: true;
			}
			
			home-controller {
				instance-class: class( com.ffsys.ioc.mock.MockHomeController );
			}
			...
			loader-factory {
				static-class: class( com.ffsys.ioc.mock.MockFactoryBean );
