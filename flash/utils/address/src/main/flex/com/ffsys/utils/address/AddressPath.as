package com.ffsys.utils.address {
	...
	*	
	*	@see com.ffsys.utils.address.AddressPathFinder
	*	@see com.ffsys.utils.address.IAddressPath
	*	@see com.ffsys.utils.address.IAddressPathCompare
	*	@see com.ffsys.utils.address.IAddressPathFinder
	*	
	*	@usage
	*	
	...
	public class AddressPath extends Proxy
		...
		*/		
		public function getCommonStringOutputMethods():Object
		{
			...
			output.getLength = getLength();
			output.getAddress = getAddress();
			return output;
		}
