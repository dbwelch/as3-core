...
These are the core Actionscript 3 libraries for Freeform Systems. All source code is distributed with a "Creative Commons attribution and share-alike license":http://creativecommons.org/licenses/by-sa/2.0/uk/.
...
You simply need to declare a repository that points to our public repository, so that the library artifact dependencies can be resolved:

bc. <repositories>
	<snapshotRepository>
		<id>ffsys-repository</id>
		<name>Freeform Systems Snapahots Repository</name>
